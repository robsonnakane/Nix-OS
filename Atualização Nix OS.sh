...
flatpak install flathub com.adobe.Flash-Player-Projector -y; flatpak install flathub com.skype.Client -y; flatpak install flathub com.transmissionbt.Transmission -y; flatpak install flathub org.gnome.Boxes -y;
